...
enum L10n {
    ...
    private static let strings: [String: (zh: String, en: String)] = {
        ...
        "viewer.layoutPaged": ("逐页", "Paged"),
        "viewer.pagePrevious": ("上一页", "Previous page"),
        "viewer.pageNext": ("下一页", "Next page"),
        "viewer.comparisonMode": ("对照方式", "Comparison mode"),
        "viewer.comparisonMode.scroll": ("滚动", "Scroll"),
        "viewer.comparisonMode.paged": ("逐页", "Paged"),
        "viewer.pageAnchor.left": ("左", "Left"),
        "viewer.pageAnchor.right": ("右", "Right"),
        "viewer.pageAnchor.help": ("自定义两侧页码对应:修改任一侧页码,建立如“原文第 2 页 = 译文第 1 页”的对照锚点", "Map pages across panes, e.g. left page 2 = right page 1"),
        "viewer.pageAnchor.invalidTitle": ("页码无效", "Invalid page number"),
        "viewer.pageAnchor.invalidMessage": ("页码必须在 1 到该 PDF 总页数之间。", "Enter a page number between 1 and the PDF's page count."),
        "viewer.pageGroup.source": ("原文", "Source"),
        "viewer.pageGroup.translation": ("译文", "Translation"),
        "viewer.pageGroup.help": ("原文页与当前译文续页进度", "Source page and translated continuation progress"),
        "viewer.zoom": ("缩放", "Zoom"),
        ...
        "translate.cleanupSummaryWithTables": ("已过滤：页眉页脚 %@ 条，页码 %@ 条，OCR 垃圾行 %@ 条；检测到 %@ 个表格区域", "Filtered: %@ header/footer, %@ page number, %@ OCR junk line(s); detected %@ table region(s)"),
